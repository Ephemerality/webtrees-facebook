...
<form method="post" action="">
  ...
  <label>
    ...
    <input type="text" name="app_id" value="<?php echo $this->getPreference('app_id', ''); ?>" />
  </label>
  <label>
    <?php echo I18N::translate('App Secret:'); ?>
    <input type="text" name="app_secret" value="<?php echo $this->getPreference('app_secret', ''); ?>" size="40" />
  </label>
  ...
  <p>
    <label>
      <input type="checkbox" name="require_verified" value="1"<?php echo ($this->getPreference('require_verified', 1) ? 'checked="checked" ' : ''); ?> />
  ...
  <p>
    <label>
      <input type="checkbox" name="hide_standard_forms" value="1"<?php echo ($this->getPreference('hide_standard_forms', 0) ? 'checked="checked" ' : ''); ?> />
